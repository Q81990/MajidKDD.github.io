...
let HubNumberToText = _decorate([e$1("hubcollab-number-to-text")], function (_initialize, _LitElement) {
  ...
  `;
      ...
      function getMetaConfig() {
        ...
        return {
          controlName: "Number To Text",
          fallbackDisableSubmit: false,
          iconUrl: "currency",
          version: "1",
          searchTerms: ["word", "words", "Currency", "Convert"],
          groupName: "Hub Collab",
          properties: {
            value: {
              type: "string",
              title: "Output Value",
            ...
            locale: {
              ...
              title: "Locale",
              defaultValue: "fr-FR",
              enum: ["en-AE", "en-BD", "en-GB", "en-GH", "en-IN", "en-MM", "en-MU", "en-NG", "en-NP", "en-US", "en-PH", "ee-EE", "fa-IR", "fr-FR", "gu-IN", "hi-IN", "mr-IN", "nl-SR", "pt-BR", "tr-TR"]
            }
          },
          standardProperties: {
            description: true,
      ...
      value: function render() {
        ...
        if (this.inputValue) {
          this.convertedValue = toWords.convert(this.inputValue, {
            currency: true
          }).toLowerCase();
        } else {
          this.convertedValue = "";
        ...
        return x`
      <div class="form-control">${this.convertedValue}</div>
      `;
      }
    }]
  };
